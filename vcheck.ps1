...
# Especially - Thanks to Rapha?l SCHITZ (http://www.hypervisor.fr/) for his contributions and time
...
$SMTPSRV = "psmtp1a.dc.gtnexus.com"
# Set the Email address to recieve from
$EmailFrom = "amon4a@gtnexus.com"
# Set the Email address to send the email to
$EmailTo = "david.potes@gtnexus.com"
...
$ntpserver = "awin1a.dc.gtnexus.com"
